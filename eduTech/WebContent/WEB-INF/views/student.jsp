...
<div class="wrapper">
    <div class="sidebar">
        ...
        <ul>
            <li><a href="./Content"><i class="fas fa-home"></i>My Account</a></li>
            <li><a href="./Course"><i class="fas fa-book"></i>My Courses</a></li>
            <li><a href="#"><i class="fas fa-users"></i>My Community</a></li>
            <li><a href="#"><i class="fas fa-project-diagram"></i>My Scores</a></li>
